...
(function (root, factory) {
    ...
    */
    ...
    Blockly.defineBlocksWithJsonArray([
        {
      type: "sem_acquire_image",
      message0: "%1 SEM Acquire Image %2 Detector: %3 dwell time:  %4 Resolution %5 Accumulation: %6  x %7",
      args0: [
        {
          type: "field_image",
          src: "https://iconplanet.app/preview/svg/camera--8144.svg",
          width: 32,
          height: 32,
          alt: "*",
          flipRtl: false
      ...
      output: "Image",
      colour: 210,
      tooltip: "Increases contrast",
      helpUrl: "https://en.wikipedia.org/wiki/Histogram_equalization"
    }]);
    Blockly.defineBlocksWithJsonArray([
        {
            type: "variables_get",
